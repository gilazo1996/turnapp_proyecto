<?php
    $output = '<a href="index.php" class="btn btn-primary">Ir a la pagina principal</a>';
?>
...
<div class="jumbotron text-center bg-transparent">  
    <div class="card-header"><h1 class="display-4 text-white">Error, debe iniciar sesion</h1></div>
